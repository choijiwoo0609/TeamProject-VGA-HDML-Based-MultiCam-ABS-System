...
##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { resetn_0 }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33     } [get_ports { ov7670_sda_0 }]; #IO_L15P_T2_DQS_13 Sch=jb_p[1]		 
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { ov7670_scl_0 }]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]         
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33     } [get_ports { ov_pclk_0 }]; #IO_L11P_T1_SRCC_13 Sch=jb_p[2]        
set_property -dict { PACKAGE_PIN V7    IOSTANDARD LVCMOS33     } [get_ports { href_0 }]; #IO_L11N_T1_SRCC_13 Sch=jb_n[2]        
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33     } [get_ports { ov7670_data_0[7] }]; #IO_L13P_T2_MRCC_13 Sch=jb_p[3]        
set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33     } [get_ports { ov7670_data_0[5] }]; #IO_L13N_T2_MRCC_13 Sch=jb_n[3]        
set_property -dict { PACKAGE_PIN V6    IOSTANDARD LVCMOS33     } [get_ports { ov7670_data_0[3] }]; #IO_L22P_T3_13 Sch=jb_p[4]             
set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33     } [get_ports { ov7670_data_0[1] }]; #IO_L22N_T3_13 Sch=jb_n[4]             
                                                                                                                                 
                                                                                                                                 
##Pmod Header JC                                                                                                                  
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { vsync_0 }]; #IO_L10P_T1_34 Sch=jc_p[1]   			 
...
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33     } [get_ports { xclk }]; #IO_L1N_T0_34 Sch=jc_n[2]              
set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33     } [get_ports { ov7670_data_0[6] }]; #IO_L8P_T1_34 Sch=jc_p[3]              
set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33     } [get_ports { ov7670_data_0[4] }]; #IO_L8N_T1_34 Sch=jc_n[3]              
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33     } [get_ports { ov7670_data_0[2] }]; #IO_L2P_T0_34 Sch=jc_p[4]              
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33     } [get_ports { ov7670_data_0[0] }]; #IO_L2N_T0_34 Sch=jc_n[4]              
                                                                                                                                 
                                                                                                                                 
##Pmod Header JD                                                                                                                  
#set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { nrf_irq_n_0 }]; #IO_L5P_T0_34 Sch=jd_p[1]                  
#set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33     } [get_ports { nrf_mosi_0 }]; #IO_L5N_T0_34 Sch=jd_n[1]				 
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33     } [get_ports { nrf_csn_0 }]; #IO_L6P_T0_34 Sch=jd_p[2]                  
#set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33     } [get_ports { jd[3] }]; #IO_L6N_T0_VREF_34 Sch=jd_n[2]             
#set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33     } [get_ports { nrf_miso_0 }]; #IO_L11P_T1_SRCC_34 Sch=jd_p[3]            
#set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33     } [get_ports { nrf_sclk_0 }]; #IO_L11N_T1_SRCC_34 Sch=jd_n[3]            
#set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33     } [get_ports { nrf_ce_0 }]; #IO_L21P_T3_DQS_34 Sch=jd_p[4]             
#set_property -dict { PACKAGE_PIN V18   IOSTANDARD LVCMOS33     } [get_ports { jd[7] }]; #IO_L21N_T3_DQS_34 Sch=jd_n[4]             
                                                                                                                                 
                                                                                                                                 
##Pmod Header JE                                                                                                                  
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { nrf_irq_n_0 }]; #IO_L4P_T0_34 Sch=je[1]						 
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { nrf_mosi_0 }]; #IO_L18N_T2_34 Sch=je[2]                     
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { nrf_csn_0 }]; #IO_25_35 Sch=je[3]                          
#set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { je[3] }]; #IO_L19P_T3_35 Sch=je[4]                     
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { nrf_miso_0 }]; #IO_L3N_T0_DQS_34 Sch=je[7]                  
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { nrf_sclk_0 }]; #IO_L9N_T1_DQS_34 Sch=je[8]                  
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { nrf_ce_0 }]; #IO_L20P_T3_34 Sch=je[9]                     
...
##========================================================
## Clock Constraints for clk_wiz_0 outputs
##========================================================

# 100 MHz clock from clk_wiz_0
create_clock -name clk100 -period 10.000 [get_pins design_1_i/clk_wiz_0/clk_100]

# 125 MHz clock from clk_wiz_0
create_clock -name clk125 -period 8.000 [get_pins design_1_i/clk_wiz_0/clk_125]

# 25 MHz clock from clk_wiz_0 (PixelClk for HDMI)
create_clock -name clk25 -period 40.000 [get_pins design_1_i/clk_wiz_0/clk_25]

##========================================================
## False Path Constraints (avoid unnecessary analysis)
##========================================================

# PixelClk ↔ SerialClk (25 MHz vs 125 MHz) are separate domains
# Vivado should not try to time between them
set_false_path -from [get_clocks clk25] -to [get_clocks clk125]
set_false_path -from [get_clocks clk125] -to [get_clocks clk25]

# If 100 MHz is used for control logic (not directly timed with HDMI),
# you may also need to block false paths across unrelated domains:
set_false_path -from [get_clocks clk25] -to [get_clocks clk100]
set_false_path -from [get_clocks clk100] -to [get_clocks clk25]
set_false_path -from [get_clocks clk125] -to [get_clocks clk100]
set_false_path -from [get_clocks clk100] -to [get_clocks clk125]

##========================================================
## Optional: Input clock constraint (if external oscillator feeds clk_in1_0)
##========================================================
# Example: if the Zybo Z7 board oscillator is 125 MHz
create_clock -name sys_clk_in -period 8.000 [get_ports clk_in1_0]

## PixelClk ↔ SerialClk: 서로 다른 도메인이므로 타이밍 분석 제외
set_clock_groups -asynchronous \
   -group [get_clocks clk25] \
   -group [get_clocks clk125]

## PixelClk ↔ sys_clk(125 MHz)도 비동기 처리
set_clock_groups -asynchronous \
   -group [get_clocks clk25] \
   -group [get_clocks clk100 clk125]